...
//           {sidebarOpen ? (
//             <p className="leading-snug">Contact us:<br />Sublite123@gmail.com</p>
//           ) : (
...
//       <div className="flex-1 flex flex-col min-h-screen">
//         <header className="relative z-20 flex items-center justify-between px-4 py-3 shadow-sm flex-wrap gap-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 min-h-[72px]">
//           <div className="flex items-center gap-3 flex-wrap">
//             <div className="flex items-center">
//               <img src="/logo.jpg" alt="logo" className="w-10 h-10 rounded-full mr-3" />
//               <h2 className="font-bold mb-0 text-[#2bb6c4] tracking-wider">Sublite</h2>
...
//           </div>
//           <div className="flex items-center gap-2 md:gap-4 relative">
//             <button className="p-2 rounded-full text-xl hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-100 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 active:scale-98" title="Settings">
//               <FaCog />
//             </button>
//             <button className="p-2 rounded-full text-xl hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-100 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 active:scale-98" onClick={toggleDarkMode}>
//               {darkMode ? <FaSun /> : <FaMoon />}
//             </button>
//             <button className="p-2 rounded-full text-xl hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-100 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 active:scale-98" title="Notifications" onClick={() => navigate('/dashboard/notifications')}>
//               <FaBell />
//             </button>
//             {userName && (
//               <button
...
//               >
//                 {user?.profilePicture ? (
//                   <img src={user.profilePicture} alt="Profile" className="w-9 h-9 rounded-full object-cover mr-2" />
//                 ) : (
//                   <span className="w-9 h-9 rounded-full bg-gray-300 text-gray-800 dark:bg-gray-600 dark:text-gray-200 flex items-center justify-center font-bold text-lg mr-2">
//                     {getInitials(userName)}
//                   </span>
