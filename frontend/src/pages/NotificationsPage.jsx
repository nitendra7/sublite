...
export default function NotificationsPage() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // For now using mock data since API might not be ready
      const mockNotifications = [
        {
          _id: '1',
          type: 'booking',
          title: 'New Booking Confirmation',
          message: 'Your Netflix Premium subscription has been confirmed!',
          isRead: false,
        ...
        },
        {
          ...
          message: 'Your Amazon Prime subscription expires in 3 days.',
          isRead: true,
