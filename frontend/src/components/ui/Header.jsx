    ...
    <header className="w-full bg-white/90 backdrop-blur-sm shadow-md fixed top-0 left-0 right-0 z-50 py-3 px-6 flex items-center justify-between
      ...
      <div className="flex items-center gap-3">
        <img
          src="/logo.jpg"
          alt="Sublite Logo"
          className="w-12 h-12 rounded-full" // Use Tailwind for w/h/border-radius
        />
        <span className="text-2xl font-extrabold text-[#2bb6c4] tracking-tight dark:text-[#5ed1dc]">Sublite</span>
      </div>
      <nav>
